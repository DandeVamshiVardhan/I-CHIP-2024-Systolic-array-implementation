...
HD_PWD='E:/vivado files/microblaze_accelerator_interface/microblaze_accelerator_interface.runs/accelerator_soc_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerator_soc_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerator_soc_xbar_0.tcl
