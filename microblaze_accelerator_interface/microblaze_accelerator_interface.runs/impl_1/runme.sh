...
HD_PWD='E:/vivado files/I_CHIP_2024/microblaze_accelerator_interface/microblaze_accelerator_interface.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerator_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accelerator_soc_wrapper.tcl -notrace
