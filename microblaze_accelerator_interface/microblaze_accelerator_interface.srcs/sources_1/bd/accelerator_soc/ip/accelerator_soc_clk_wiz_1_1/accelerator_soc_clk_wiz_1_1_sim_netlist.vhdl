...
-- Command     : write_vhdl -force -mode funcsim -rename_top accelerator_soc_clk_wiz_1_1 -prefix
--               accelerator_soc_clk_wiz_1_1_ accelerator_soc_clk_wiz_1_1_sim_netlist.vhdl
...
entity accelerator_soc_clk_wiz_1_1_accelerator_soc_clk_wiz_1_1_clk_wiz is
  port (
...
end accelerator_soc_clk_wiz_1_1_accelerator_soc_clk_wiz_1_1_clk_wiz;

architecture STRUCTURE of accelerator_soc_clk_wiz_1_1_accelerator_soc_clk_wiz_1_1_clk_wiz is
  signal clk_in1_accelerator_soc_clk_wiz_1_1 : STD_LOGIC;
  signal clk_out1_accelerator_soc_clk_wiz_1_1 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_accelerator_soc_clk_wiz_1_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_accelerator_soc_clk_wiz_1_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_accelerator_soc_clk_wiz_1_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_accelerator_soc_clk_wiz_1_1,
...
entity accelerator_soc_clk_wiz_1_1 is
  ...
  attribute NotValidForBitStream of accelerator_soc_clk_wiz_1_1 : entity is true;
end accelerator_soc_clk_wiz_1_1;

architecture STRUCTURE of accelerator_soc_clk_wiz_1_1 is
begin
inst: entity work.accelerator_soc_clk_wiz_1_1_accelerator_soc_clk_wiz_1_1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
