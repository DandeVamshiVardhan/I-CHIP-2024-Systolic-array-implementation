...
--               files/microblaze_accelerator_interface/microblaze_accelerator_interface.srcs/sources_1/bd/accelerator_soc/ip/accelerator_soc_clk_wiz_1_0/accelerator_soc_clk_wiz_1_0_sim_netlist.vhdl}
-- Design      : accelerator_soc_clk_wiz_1_0
...
entity accelerator_soc_clk_wiz_1_0_accelerator_soc_clk_wiz_1_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of accelerator_soc_clk_wiz_1_0_accelerator_soc_clk_wiz_1_0_clk_wiz : entity is "accelerator_soc_clk_wiz_1_0_clk_wiz";
end accelerator_soc_clk_wiz_1_0_accelerator_soc_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of accelerator_soc_clk_wiz_1_0_accelerator_soc_clk_wiz_1_0_clk_wiz is
  signal clk_in1_accelerator_soc_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out1_accelerator_soc_clk_wiz_1_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_accelerator_soc_clk_wiz_1_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_accelerator_soc_clk_wiz_1_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_accelerator_soc_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_accelerator_soc_clk_wiz_1_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity accelerator_soc_clk_wiz_1_0 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of accelerator_soc_clk_wiz_1_0 : entity is true;
end accelerator_soc_clk_wiz_1_0;

architecture STRUCTURE of accelerator_soc_clk_wiz_1_0 is
begin
inst: entity work.accelerator_soc_clk_wiz_1_0_accelerator_soc_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
