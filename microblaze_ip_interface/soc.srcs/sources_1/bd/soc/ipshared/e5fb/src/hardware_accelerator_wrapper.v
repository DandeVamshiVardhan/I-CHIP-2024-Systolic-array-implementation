...
//Date        : Tue May 20 12:35:50 2025
//Host        : LAPTOP-7P8LB6PD running 64-bit major release  (build 9200)
//Command     : generate_target hardware_accelerator_wrapper.bd
//Design      : hardware_accelerator_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module hardware_accelerator_wrapper
   (ACLK,
    ARESETN,
    M_AXI_0_araddr,
    M_AXI_0_arprot,
  ...
  wire [5:0]S_AXI_0_araddr;
  wire [2:0]S_AXI_0_arprot;
  wire S_AXI_0_arready;
  wire S_AXI_0_arvalid;
  wire [5:0]S_AXI_0_awaddr;
  ...
  hardware_accelerator hardware_accelerator_i
       (.ACLK(ACLK),
        .ARESETN(ARESETN),
