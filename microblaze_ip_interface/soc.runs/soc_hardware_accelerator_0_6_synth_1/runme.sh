...
HD_PWD='E:/vivado files/I_CHIP_2024/microblaze_ip_interface/soc.runs/soc_hardware_accelerator_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_hardware_accelerator_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_hardware_accelerator_0_6.tcl
