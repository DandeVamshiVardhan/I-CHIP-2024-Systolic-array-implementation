...
HD_PWD='E:/vivado files/I_CHIP_2024/microblaze_ip_interface/soc.runs/soc_axi_bram_ctrl_0_bram_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_axi_bram_ctrl_0_bram_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_axi_bram_ctrl_0_bram_7.tcl
