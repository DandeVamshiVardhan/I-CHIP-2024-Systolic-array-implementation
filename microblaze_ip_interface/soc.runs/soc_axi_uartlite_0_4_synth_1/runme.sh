...
HD_PWD='E:/vivado files/I_CHIP_2024/microblaze_ip_interface/soc.runs/soc_axi_uartlite_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_axi_uartlite_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_axi_uartlite_0_4.tcl
