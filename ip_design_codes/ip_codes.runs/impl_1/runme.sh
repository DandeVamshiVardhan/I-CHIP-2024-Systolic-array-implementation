...
HD_PWD='E:/vivado files/I_CHIP_2024/ip_design_codes/ip_codes.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_accelerator_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hardware_accelerator_wrapper.tcl -notrace
