...
HD_PWD='E:/vivado files/I_CHIP_2024/ip_design_codes/ip_codes.runs/hardware_accelerator_and_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_accelerator_and_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware_accelerator_and_gate_0_0.tcl
