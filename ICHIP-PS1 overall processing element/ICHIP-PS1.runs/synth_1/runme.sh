...
HD_PWD='E:/vivado files/I_CHIP_2024/ICHIP-PS1 overall processing element/ICHIP-PS1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_elemen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processing_elemen.tcl
