...
HD_PWD='E:/vivado files/I_CHIP_2024/ICHIP-PS1 overall processing element/ICHIP-PS1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_elemen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processing_elemen.tcl -notrace
