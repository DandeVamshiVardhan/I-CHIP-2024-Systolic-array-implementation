...
HD_PWD='E:/vivado files/I_CHIP_2024/axi master and slave implementation/axi-4 implmentation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_acceletor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hardware_acceletor_wrapper.tcl -notrace
