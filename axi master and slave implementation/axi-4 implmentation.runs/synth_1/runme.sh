...
HD_PWD='E:/vivado files/I_CHIP_2024/axi master and slave implementation/axi-4 implmentation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_acceletor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware_acceletor_wrapper.tcl
