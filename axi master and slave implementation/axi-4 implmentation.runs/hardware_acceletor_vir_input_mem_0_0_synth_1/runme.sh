...
HD_PWD='E:/vivado files/axi master and slave implementation/axi-4 implmentation.runs/hardware_acceletor_vir_input_mem_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_acceletor_vir_input_mem_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hardware_acceletor_vir_input_mem_0_0.tcl
