...
################################################################
# This is a generated script based on design: hardware_acceletor
#
...
# source hardware_acceletor_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axi_master, axi_slave, controller, input_mem, output_mem, systolic_array, vir_input_mem, weight_mem
...
set design_name hardware_acceletor
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports S_AXI_ACLK] [get_bd_pins axi_master_0/M_AXI_ACLK] [get_bd_pins axi_slave_0/S_AXI_ACLK] [get_bd_pins controller_0/clk] [get_bd_pins input_mem_0/clk] [get_bd_pins output_mem_0/clk] [get_bd_pins systolic_array_0/clk] [get_bd_pins vir_input_mem_0/clk] [get_bd_pins weight_mem_0/clk]
  connect_bd_net -net Net1 [get_bd_ports S_AXI_ARESETN] [get_bd_pins axi_master_0/M_AXI_ARESETN] [get_bd_pins axi_slave_0/S_AXI_ARESETN] [get_bd_pins controller_0/arestn] [get_bd_pins input_mem_0/arestn] [get_bd_pins output_mem_0/arestn] [get_bd_pins systolic_array_0/aresetn] [get_bd_pins vir_input_mem_0/arestn] [get_bd_pins weight_mem_0/arestn]
  connect_bd_net -net Net2 [get_bd_pins axi_master_0/rd_data] [get_bd_pins input_mem_0/wr_data] [get_bd_pins weight_mem_0/wr_data]
  connect_bd_net -net axi_master_0_capture_image_data [get_bd_pins axi_master_0/capture_image_data] [get_bd_pins input_mem_0/wr_enable]
  connect_bd_net -net axi_master_0_capture_kernel_data [get_bd_pins axi_master_0/capture_kernel_data] [get_bd_pins weight_mem_0/wr_enable]
  connect_bd_net -net axi_master_0_ended_convolution [get_bd_pins axi_master_0/ended_convolution] [get_bd_pins axi_slave_0/end_convolution]
  connect_bd_net -net axi_master_0_ended_reading [get_bd_pins axi_master_0/ended_reading] [get_bd_pins controller_0/reading_ended]
  ...
  connect_bd_net -net axi_slave_0_image_dimension [get_bd_pins axi_master_0/image_dimension] [get_bd_pins axi_slave_0/image_dimension] [get_bd_pins controller_0/image_dimension]
  connect_bd_net -net axi_slave_0_interrupt [get_bd_ports interrupt_0] [get_bd_pins axi_slave_0/interrupt]
  ...
  connect_bd_net -net controller_0_rd_address [get_bd_pins controller_0/rd_address] [get_bd_pins vir_input_mem_0/rd_address] [get_bd_pins weight_mem_0/counter]
  connect_bd_net -net controller_0_start_wr_fsm [get_bd_pins axi_master_0/start_writing_fsm] [get_bd_pins controller_0/start_wr_fsm]
  ...
  connect_bd_net -net input_mem_0_rd_data [get_bd_pins input_mem_0/rd_data] [get_bd_pins vir_input_mem_0/wr_data]
  connect_bd_net -net output_mem_0_rd_data [get_bd_pins axi_master_0/output_image_data] [get_bd_pins output_mem_0/rd_data]
  connect_bd_net -net systolic_array_0_rd_data [get_bd_pins output_mem_0/wr_data] [get_bd_pins systolic_array_0/rd_data]
  connect_bd_net -net vir_input_mem_0_rd_data [get_bd_pins systolic_array_0/input_data] [get_bd_pins vir_input_mem_0/rd_data]
  connect_bd_net -net weight_mem_0_rd_data [get_bd_pins systolic_array_0/weight_data] [get_bd_pins weight_mem_0/rd_data]

  # Create address segments
  create_bd_addr_seg -range 0x00020000 -offset 0x44A00000 [get_bd_addr_spaces axi_master_0/M_AXI] [get_bd_addr_segs M_AXI_0/Reg] SEG_M_AXI_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces S_AXI_0] [get_bd_addr_segs axi_slave_0/S_AXI/reg0] SEG_axi_slave_0_reg0
